        ...
        "columns": [
            ...
            
            {
                "render": function (data, type, full) {
                    return "<a href='/Admin/Slider/Edit?id=" + full.sliderID + "' class='btn btn-xs btn-outline-success'><i class='fas fa-edit'></i></a>";
                }
            },
            {
                "render": function (data, type, full) {
                    return "<a href='/Admin/Slider/Delete?id=" + full.sliderID + "' class='btn btn-xs btn-outline-danger'><i class='fas fa-window-close'></i></a>";
                }
            }, 
