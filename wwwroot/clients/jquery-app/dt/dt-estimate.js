    ...
    $("#cbtn-selectors1").dataTable({
        ...
        "columns": [
            ...
            
            {
                "render": function (data, type, full)
                {
                    return "<a href='/Edit/" + full.EstimateID + "' class='btn btn-success btn-mini btn-outline-primary'><i class='fas fa-edit'></i></a>";                        
                }
            },
            {               
                "render": function (data, type, full) {
                    return "<a href='/Delete/" + full.EstimateID + "' class='btn btn-danger btn-mini btn-outline-primary'><i class='fas fa-window-close'></i></a>";        
                }
            },
